...
session_start();
  ...
  $logdob = mysqli_real_escape_string($conn,md5($_POST['logdob']));
  ...
  if(mysqli_num_rows($result)>0){
      ...
      //$sql4 = "INSERT INTO userimage(firstname,username,filename) VALUES ('{$logfname}','{$loguname}','{$img_name}')";
              ...
              <div class="card-back">
                <div class="center-wrap">
                  <div class="section text-center">
                    ...
                    <div class="form-group mt-2">
                      <input type="number" name="logumnumber" class="form-style" placeholder="Your Mobile Number " id="logumnumber" autocomplete="off">
                       
                    </div>
                    <div class="form-group mt-2">
                      <input type="number" name="logufmnumber" class="form-style" placeholder="Your Father's Mobile number " id="logufmnumber" autocomplete="off">
                       
                    </div>
                    <div class="form-group mt-2">
                      <input type="number" name="logummnumber" class="form-style" placeholder="Your Mother's mobile number " id="logummnumber" autocomplete="off">
