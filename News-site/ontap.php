...
<body>
    ...
    <div class="parent" style="background-color:white;margin-left:30%;margin-right:30%;margin-top:10%;border-radius:20px;">
        ...
        <div>
            <center><button class="btn"><a class="linkDecoration" href="./loginpage.php?loguname=<?php echo $loguname?>">Login</a></button></center>
            <br><br>
        </div>
        <div class="parent">
            <div class="child" style="margin-left:3%"><button class="btn"><a class="linkDecoration" href="./addprescription.php?pfn=Govind&did=12345678910&pln=Jha&pun=sam&pid=41673163612&dfn=Dharm&dln=Patel&dun=Dharm">Add Prescription</a></button></div>
